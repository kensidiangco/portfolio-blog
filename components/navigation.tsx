...
export default function Navigation() {
    ...
    return (
        <nav className="sticky shadow-md top-0 z-50 bg-light-nav-footer dark:bg-nav-footer dark:text light-text flex items-center justify-between">
            <div className="pl-4 font-semibold space-x-4 flex items-center">
                <Link href="/" passHref>
                    <span className="cursor-pointer font-extrabold text-xl text-transparent bg-clip-text bg-gradient-to-br from-pink-600 to-blue-400">KEN.</span>
                </Link>
            </div>
            ...
            {/* Dropdown Item */}
            {showDropdown && 
                <div className="px-2 py-4 absolute shadow-lg w-full md:w-32 md:right-0 md:mr-2 top-3/4 md:w-1/4 rounded-md mt-2 font-semibold space-y-1 justify-center overflow-hidden backdrop-filter backdrop-blur-2xl shadow-xl"
                    ref={dropdown}
                >
